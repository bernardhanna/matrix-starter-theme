...
@section('content')
    ...
    <h1 class="text-4xl font-bold mb-6 flex gap-6 items-center">
        <x-icon-matrix class="w-24 h-24" />
        <b>Welcome to matrix</b>
    </h1>

    <p class="my-6"><x-button href="https://roots.io/matrix/docs/installation/">matrix Docs</x-button></p>
    ...
    <p class="my-4">The <code>matrix/modal</code> block is rendered with the <code>x-modal</code> Blade component.</p>
